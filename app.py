...
def home():
    if request.method == "POST":
        ...
        number_of_recommendations = request.form.get("number_of_recommendations")
        ...
        return render_template(
            "home.html",
            recommender_output=recommender_output,
            n_rec=number_of_recommendations,
            input_movie=input_movie,
            enumerate=enumerate,
            key=custom_search_api,
            cx=custom_search_code,
        )
